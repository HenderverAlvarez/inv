...
$unidad->modificar_Unidad($serial,$rif,$modelo,$banco,$afiliacion,$n_terminal,$fantasia,$razonSocial,$localizacion,$status,$serial_sustituto1,$serial_sustituto2,$serial_sustituto3, $realizadopor);
...
/*Se registra el equipo en la base de datos*/
	...
	$mov=new Inventario($serial,$fecha, $realizadopor, $n_terminal, $afiliacion, "modificacion");
	$mov->guardar_mov($serial, $fecha, $realizadopor, $n_terminal, $afiliacion, "modificacion");	
