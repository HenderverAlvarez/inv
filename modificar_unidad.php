...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
 ...
 $status=$_POST['status'];
 if (isset($_POST['serial_sustituto1'])) {$serial_sustituto1=filter_var($_POST['serial_sustituto1'], FILTER_SANITIZE_STRING);}else{$serial_sustituto1=0;} 
 if (isset($_POST['serial_sustituto2'])) {$serial_sustituto2=filter_var($_POST['serial_sustituto2'], FILTER_SANITIZE_STRING);}else{$serial_sustituto2=0;} 
 if (isset($_POST['serial_sustituto3'])) {$serial_sustituto3=filter_var($_POST['serial_sustituto3'], FILTER_SANITIZE_STRING);}else{$serial_sustituto3=0;} 
...
require 'views/modificar_unidad.view.php';
 ?>