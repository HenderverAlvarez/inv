...
$direccion="mod_equipo.php?serial=".$serial."&rif=".$rif."&idmodelo=".$idmodelo."&idbanco=".$idbanco."&afiliado=".$afiliacion."&terminal=".$n_terminal."&fantasia=".$fantasia."&razon=".$razonSocial."&idlocalizacion=".$idlocalizacion."&idstatus=".$idstatus."&realizadopor=".$realizadopor."&serial_sustituto1=". $serial_sustituto1."&serial_sustituto2=". $serial_sustituto2."&serial_sustituto3=". $serial_sustituto3;
...
require 'views/conf_equipo.view.php';
 ?>
